...
class Ensembles extends Taxonomy {
	...
	public function get_tax_args() {
		...
		$labels = [
			...
			'separate_items_with_commas' => __( 'Separate ensembles with commas', 'full-score-events' ),
			'add_or_remove_items'        => __( 'Add or remove ensembles', 'full-score-events' ),
			...
			'no_terms'                   => __( 'No ensembles', 'full-score-events' ),
