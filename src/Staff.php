	...
	public function get_cpt_args() {
		return [
			...
			'labels'              => [
				...
				'featured_image'        => __( 'Staff Photo', 'full-score-events' ),
				'set_featured_image'    => __( 'Set staff photo', 'full-score-events' ),
				'remove_featured_image' => __( 'Remove staff photo', 'full-score-events' ),
				'use_featured_image'    => __( 'Use as staff photo', 'full-score-events' ),
